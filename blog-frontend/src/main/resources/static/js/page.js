...
;(function( $ ) {
	...
	$.fn.datatable = function( options ) {
		...
		function createdRow_(row, data, index) {
			$(row).html('');
		}
		...
		function retrieveData_(sSource, aoData, fnCallback) {
			...
			$.ajax( {   
		        ...
		        "success": function(resp) {
                    ...
                    if(options_.ajaxCallBack != null && typeof options_.ajaxCallBack === "function") {
                        options_.ajaxCallBack.call(this, resp);
                    }
		        },
